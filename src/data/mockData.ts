...
export const aiAlerts = [
  { id: 1, tipo: 'warning' as const, msg: 'Talhão A3 — 84 SCA: separe este lote como Specialty antes de misturar. Vender como commodity custa R$ 1.486.464 em receita não realizada (1.176 sc × R$ 1.264/sc de diferença).', prioridade: 'alta', data: '16/04/2026' },
  { id: 2, tipo: 'danger' as const, msg: 'Talhão B1 com queda de produtividade consistente por 3 safras (520→470→410 sacas). Análise de solo e revisão de irrigação recomendadas.', prioridade: 'alta', data: '15/04/2026' },
  { id: 3, tipo: 'info' as const, msg: 'Melhor janela de venda histórica: Agosto–Outubro. Com 620 sacas em estoque, aguardar pode render até R$ 95.480 adicionais (vs. preço atual).', prioridade: 'media', data: '15/04/2026' },
